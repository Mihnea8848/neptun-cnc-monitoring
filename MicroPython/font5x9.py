...
# 5x9 font bitmap data
# Each character is represented as a list of bytes
# Each byte represents one row of the 5-pixel wide character
# Bit 7 (0x80) is leftmost pixel, bit 3 (0x08) is rightmost pixel

font5x9 = [
    # Space (32)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
    # ! (33)
    [0x00, 0x00, 0x20, 0x20, 0x20, 0x20, 0x00, 0x20, 0x00],
    # " (34)
    ...
    # ' (39)
    [0x00, 0x30, 0x30, 0x20, 0x40, 0x00, 0x00, 0x00, 0x00],
    # ( (40)
    ...
    # , (44)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x30, 0x20, 0x40],
    # - (45)
    [0x00, 0x00, 0x00, 0x00, 0xF8, 0x00, 0x00, 0x00, 0x00],
    # . (46)
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00],
    # / (47)
    ...
    # ; (59)
    [0x00, 0x00, 0x30, 0x30, 0x00, 0x30, 0x30, 0x20, 0x40],
    # < (60)
    ...
    # @ (64)
    [0x00, 0x70, 0x88, 0xB8, 0xA8, 0xB8, 0x80, 0x78, 0x00],
    # A (65)
    ...
    # G (71)
    [0x00, 0x70, 0x88, 0x80, 0x98, 0x88, 0x88, 0x70, 0x00],
    # H (72)
    ...
    # M (77)
    [0x00, 0x88, 0xD8, 0xA8, 0xA8, 0x88, 0x88, 0x88, 0x00],
    # N (78)
    [0x00, 0x88, 0xC8, 0xC8, 0xA8, 0x98, 0x98, 0x88, 0x00],
    # O (79)
    ...
    # V (86)
    [0x00, 0x88, 0x88, 0x88, 0x88, 0x50, 0x50, 0x20, 0x00],
    # W (87)
    ...
    # [ (91)
    [0x00, 0x70, 0x40, 0x40, 0x40, 0x40, 0x40, 0x70, 0x00],
    # \ (92)
    [0x00, 0x80, 0x40, 0x40, 0x20, 0x10, 0x10, 0x08, 0x00],
    # ] (93)
    [0x00, 0x70, 0x10, 0x10, 0x10, 0x10, 0x10, 0x70, 0x00],
    # ^ (94)
    ...
    # ` (96)
    [0x00, 0x60, 0x30, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00],
    # a (97)
    [0x00, 0x00, 0x70, 0x08, 0x78, 0x88, 0x88, 0x78, 0x00],
    # b (98)
    [0x00, 0x80, 0x80, 0xF0, 0x88, 0x88, 0x88, 0xF0, 0x00],
    # c (99)
    [0x00, 0x00, 0x70, 0x88, 0x80, 0x80, 0x88, 0x70, 0x00],
    # d (100)
    [0x00, 0x08, 0x08, 0x78, 0x88, 0x88, 0x88, 0x78, 0x00],
    # e (101)
    [0x00, 0x00, 0x70, 0x88, 0xF8, 0x80, 0x88, 0x70, 0x00],
    # f (102)
    [0x00, 0x30, 0x48, 0x40, 0xF0, 0x40, 0x40, 0x40, 0x00],
    # g (103)
    ...
    # k (107)
    [0x00, 0x80, 0x80, 0x88, 0x90, 0xE0, 0x90, 0x88, 0x00],
    # l (108)
    [0x00, 0x60, 0x20, 0x20, 0x20, 0x20, 0x20, 0x70, 0x00],
    # m (109)
    [0x00, 0x00, 0xD0, 0xA8, 0xA8, 0xA8, 0xA8, 0xA8, 0x00],
    # n (110)
    [0x00, 0x00, 0xF0, 0x88, 0x88, 0x88, 0x88, 0x88, 0x00],
    # o (111)
    [0x00, 0x00, 0x70, 0x88, 0x88, 0x88, 0x88, 0x70, 0x00],
    
    # p (112)
    [0x00, 0x00, 0xF0, 0x88, 0x88, 0x88, 0xF0, 0x80, 0x80],
    # q (113)
    [0x00, 0x00, 0x78, 0x88, 0x88, 0x88, 0x78, 0x08, 0x08],
    # r (114)
    [0x00, 0x00, 0xB0, 0xC8, 0x80, 0x80, 0x80, 0x80, 0x00],
    # s (115)
    [0x00, 0x00, 0x78, 0x80, 0x70, 0x08, 0x88, 0x70, 0x00],
    # t (116)
    [0x00, 0x40, 0x40, 0xF0, 0x40, 0x40, 0x48, 0x30, 0x00],
    # u (117)
    [0x00, 0x00, 0x88, 0x88, 0x88, 0x88, 0x98, 0x68, 0x00],
    # v (118)
    [0x00, 0x00, 0x88, 0x88, 0x88, 0x50, 0x50, 0x20, 0x00],
    # w (119)
    [0x00, 0x00, 0x88, 0x88, 0xA8, 0xA8, 0xD8, 0x88, 0x00],
    # x (120)
    [0x00, 0x00, 0x88, 0x50, 0x20, 0x50, 0x88, 0x88, 0x00],
    # y (121)
    [0x00, 0x00, 0x88, 0x88, 0x88, 0x78, 0x08, 0x88, 0x70],
    # z (122)
    [0x00, 0x00, 0xF8, 0x10, 0x20, 0x40, 0x80, 0xF8, 0x00],
    # { (123)
    [0x00, 0x18, 0x20, 0x20, 0x40, 0x20, 0x20, 0x18, 0x00],
    # | (124)
    [0x00, 0x20, 0x20, 0x20, 0x00, 0x20, 0x20, 0x20, 0x00],
    # } (125)
    [0x00, 0x60, 0x10, 0x10, 0x08, 0x10, 0x10, 0x60, 0x00],
    # ~ (126)
    [0x00, 0x00, 0x68, 0xB0, 0x00, 0x00, 0x00, 0x00, 0x00]
]

# Font metrics
FONT_WIDTH = 5
FONT_HEIGHT = 9
FONT_SPACING = 1  # Additional spacing between characters